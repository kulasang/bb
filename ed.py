...
cl = LINETCR.LINE()
cl.login(token="ErvLJDdQtw0v7jmCiSN7.JCxLmhfn3/VLfwqc5bVyPW.6LzbPfBOHOTTfIQ6Dzvi/WS6PmGJZkDHUOHomMyyWdQ=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u8dc5e530714ddfebe5156402e41bd8a7"}
                cl.sendMessage(msg)
