...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application': 'CHROMEOS\t7.14.0\tChrome_OS\t1', 'X-Line-Access': self.authToken, 'User-Agent': 'Line/8.4.2'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'CHROMEOS\t7.14.0\tChrome_OS\t1', 
